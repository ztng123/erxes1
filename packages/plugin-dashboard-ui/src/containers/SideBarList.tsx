...
const TypesListContainer = (props: FinalProps) => {
  const { listDashboardTypeQuery, typesEdit, typesRemove, history } = props;

  if (listDashboardTypeQuery.loading) {
    return <Spinner />;
  }
  ...
  const renderButton = ({
    ...
    return (
      <ButtonMutate
        ...
        refetchQueries={['listDashboardTypeQuery']}
      />
    );
  };
  ...
  const updatedProps = {
    ...
    loading: listDashboardTypeQuery.loading,
    remove,
    renderButton
  };
